...
export default function MedicinalPlant() {
    ...
    let MedicinalPlantContentInfos = [
        ...
        {id: 4, title: 'برسی آسیب های احتمالی', desc: 'تمامی آسیب های احتمالی برسی میگردد تا از وقوع مشکلات آینده جلوگیری شود'},
        {id: 5, title: 'از بین بردن عناصر آلوده خاک', desc: 'با استفاده از روش های نوین،عناصر آلوده از خاک گیاهان شما جمع آوری میشوند'},
        {id: 6, title: 'برسی ظاهر', desc: 'ظاهر گیاه بیانگر مسائل مهمی هست.میتوان با مشاهده ظاهر گیاه آفات و ... را متوجه شد'},
